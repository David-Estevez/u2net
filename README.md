...
Implementation of "U^2-Net: Going Deeper with Nested U-Structure for Salient Object Detection" packaged for easy use.

The code and models are taken from the [original repo](https://github.com/xuebinqin/U-2-Net), I just prepared the code to be simple(r) to use.
...
`
pip install git+https://github.com/David-Estevez/u2net.git
`
...
To use the model on a given image (e.g. `image.jpg`):

```python
from skimage.io import imread
from u2net import u2net

model = u2net('u2net')  # Creates and loads the basic model

image = imread('image.jpg')  # Loads image with Scikit-image, as it is already a dependency of this repo

mask = model.predict(image)  # Finds the salient object(s) in the image as a segmentation mask
```

## Original README.md

The original README.md has been kept right after the next line.

---

<p align="center">
  <img width="320" height="320" src="https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/U2Net_Logo.png">
...
![rm_bg](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/rm_bg.JPG)
...
![art_transfer](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/art_transfer.JPG)
...
![gradio_web_demo](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/gradio_web_demo.jpg)
...
![LensOCR APP](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/LensOCR.jpg)
...
![Clipping Camera APP](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/clipping_camera.jpg)
...
![Profuai](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/profuai.png) <br/>
...
![Human Image Segmentation](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/human_seg.png) <br/>
![Human Video](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/human_seg_video.gif)
![Human Video Results](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/human_seg_results.gif)
...
![Sample Results: Kids](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/portrait_kids.png)

![Sample Results: Ladies](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/portrait_ladies.png)

![Sample Results: Men](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/portrait_men.png)
...
![U<sup>2</sup>-Net Results](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/u2netqual.png)
...
![U<sup>2</sup>-Net architecture](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/U2NETPR.png)


## Quantitative Comparison

![Quantitative Comparison](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/quan_1.png)

![Quantitative Comparison](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/quan_2.png)


## Qualitative Comparison

![Qualitative Comparison](https://raw.githubusercontent.com/xuebinqin/U-2-Net/master/figures/qual.png?raw=true)
